 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTL | LGUI | LALT |LOWER | / BkSpc /       \Space \  |RAISE | Home | PgDn | End  |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_SFTENT,
                KC_LCTRL, KC_LGUI, KC_LALT, KC_LOWER, KC_BSPC,      KC_SPC,  KC_RAISE, KC_HOME, KC_PGDN, RCTL_T(KC_END)
),
/*
 * ARROWS
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_ARROWS] = LAYOUT(
    ...
    KC_LSFT,  LCTL(KC_Z), LCTL(KC_X),   LCTL(KC_C), LCTL(KC_V), KC_NO,  KC_MUTE,    XXXXXXX,KC_ACL1,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_SFTENT,
                                KC_LCTRL, KC_LGUI, KC_LALT, KC_LOWER, KC_BSPC,      KC_SPC,  KC_RAISE, KC_HOME, KC_PGDN, RCTL_T(KC_END)
),
/* NUMPAD
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
[_NUMPAD] = LAYOUT(
    KC_ESC,     KC_NO,  KC_NO,     KC_NO,   KC_NO,  KC_NO,                       KC_NO, KC_PAST,    KC_SLS,   KC_PMNS,  KC_NO,      KC_F11,
    ...
    KC_LSFT,    KC_NO,  KC_NO,     KC_NO,   KC_NO,  KC_P0, KC_MUTE,       KC_NO, KC_P1, KC_P2,      KC_P3,    KC_PEQL,  KC_BSLS,    KC_SFTENT,
                    KC_LCTRL, KC_LGUI, KC_LALT, KC_LOWER, KC_BSPC,      KC_SPC,  KC_RAISE, KC_HOME, KC_PGDN, RCTL_T(KC_END)
),
